...
class StatistikController extends Controller
{
    ...
    private function viewData(string $title, ?StatistikDesa $item = null): array
    {
        return [
            'title'       => $title,
            'item'        => $item,
            'storeRoute'  => 'admin.statistik.store',
            'updateRoute' => 'admin.statistik.update',
            'indexRoute'  => 'admin.statistik.index',
    ...
    public function index()
    {
        return view('admin.shared.generic_index', [
            ...
            'createRoute' => 'admin.statistik.create',
            'editRoute'   => 'admin.statistik.edit',
            'deleteRoute' => 'admin.statistik.destroy',
    ...
    {
        return view('admin.shared.generic_form', $this->viewData('Statistik Desa'));
    }
    ...
    {
        return view('admin.shared.generic_form', $this->viewData('Statistik Desa', $statistik));
    }
    ...
    public function destroy(StatistikDesa $statistik)
    {
        $statistik->delete();
        return back()->with('success', 'Data dihapus!');
    }

    public function show(StatistikDesa $statistik)
    {
